...
<div class="col-sm-4">
	...
	<img src="<?= base_url('foto_kepsek/'.$setting->foto_kepsek) ?>" width="150px" height="160px">
	<br>
...
<div class="col-sm-8">
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" value="<?= $setting->no_telp ?>" type="text" name="no_telp">
    </div>
