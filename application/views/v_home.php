		...
		<div class="container">
			...
			<div class="row courses_row">
				...
				<div class="col-lg-4 course_col">
					<div class="course">
						<div class="course_image"><img src="<?= base_url('gambar_berita/'.$value->gambar_berita) ?>" height="200px"></div>
	...
	<div class="team">
		...
		<div class="container">
			...
			<div class="row team_row">
				...
				<div class="row">
				<div class="col">
					<div class="courses_button trans_200"><a href="<?= base_url('home/guru') ?>">View All Teacher</a></div>
				</div>
			</div>
